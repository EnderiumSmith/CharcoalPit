...
public class Config {
	...
	private static void initConfig(Configuration cfg){
		...
		CokeBlocks=cfg.getStringList("CokeBlocks", CATEGORY_COKE_OVEN, new String[]{"minecraft:brick_block","minecraft:nether_brick","minecraft:brick_stairs","minecraft:nether_brick_stairs","minecraft:red_nether_brick","minecraft:obsidian"}, "List of block registry names that are valid for the coke oven outer shell");
		...
		ThatchID=cfg.getString("ThatchID", CATEGORY_KILN, "charcoal_pit:straw", "The block used as thatch for the pottery kiln");
		...
		DisableFurnaceOre=cfg.getBoolean("DisableFurnaceOre", CATEGORY_KILN, true, "If furnace ore smelting recipes should be disabled");
